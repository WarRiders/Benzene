...
contract Migratable {
    ...
    modifier isMigration(
        string memory contractName,
        string memory requiredMigrationId,
        string memory newMigrationId
    ) {
        require(
     ...
     */
    function isMigrated(string memory contractName, string memory migrationId)
        public
        view
        returns (bool)
    {
     ...
     * @param migrationId Identifier of the migration.
     */
    function validateMigrationIsPending(
        string memory contractName,
        string memory migrationId
    ) private view {
        require(
